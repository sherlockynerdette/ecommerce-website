...
{
    public partial class EditSubCatgeory : System.Web.UI.Page
    {
        string ID = "";
        string SCName = "";
        string MainCID = "";
        ...
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ManashreeConnectionString"].ConnectionString))
            {
                if (con.State == ConnectionState.Closed) { con.Open(); }
