<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DeleteProduct.aspx.cs" Inherits="Manashreefab.DeleteProduct" %>
         ...
         <div class="form-group">
          ...
          <div class="form-group">
                        <asp:Button ID="btnUpdateBrand" CssClass ="btn btn-primary " runat="server" 
                            Text="Delete" OnClick="btnUpdateBrand_Click"   />
                    </div>
         </div>
          ...
          <div class="col-md-6">
             ...
             <div class="row">
                <div class="col-md-12">
                <h4 class="alert-info text-center"> All Product</h4>
                <br />
